...
<head>
	...
	<link href="/tp/Public/media/css/login.css" rel="stylesheet" type="text/css"/>
...
<body class="login">
	...
	<div class="logo">
		...
		<img src="/tp/Public/media/image/logo-big.png" alt="" /> 
	...
	<div class="content">
		...
		<form class="form-vertical login-form" action="<?php echo U('Login/createAccount');?>" type="POST">
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-lock"></i>
						<input class="m-wrap placeholder-no-fix" type="password" placeholder="新密码" name="pwd"/>
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-lock"></i>
						<input class="m-wrap placeholder-no-fix" type="password" placeholder="再次输入密码" name="pwd1"/>
					</div>
				</div>
			</div>
			<div class="form-actions">
				<a href="<?php echo U('Login/index');?>" class="btn default pull-right">
				取消
				</a>
	...
	<script src="/tp/Public/media/js/jquery.validate.min.js" type="text/javascript"></script>
	...
	<script src="/tp/Public/media/js/login.js" type="text/javascript"></script>      
