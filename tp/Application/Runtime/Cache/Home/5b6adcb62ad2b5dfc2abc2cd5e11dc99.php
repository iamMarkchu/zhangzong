...
<body class="login">
	...
	<div class="content">
		...
		<form class="form-vertical login-form" action="<?php echo U('Login/checkLogin');?>" type="POST">
			<h3 class="form-title">欢迎登录张总后台系统</h3>
			...
			<div class="create-account">
				<p>
					<a href="<?php echo U('Login/register');?>" class="">注册一个账号?</a>
				</p>
			</div>
		</form>
		<!-- END LOGIN FORM -->        
