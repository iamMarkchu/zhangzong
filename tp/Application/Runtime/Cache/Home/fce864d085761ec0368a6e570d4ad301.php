	...
	<!-- BEGIN SIDEBAR MENU -->        
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<!-- END PAGE HEADER-->			
					 <form action="<?php echo U('Wenben/upload');?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
		<div class="control-group">
			<label class="control-label">上传文本</label>
			<div class="controls">
				<input type="file" name="file"/>
				<span class="help-inline">需要上传的文本</span>
			</div>
		</div>
		<div class="form-actions">
			...
			<a href="<?php echo U('Index/index');?>" class="btn">取消</a>
