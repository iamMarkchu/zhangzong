		...
		<div class="span12">
			<div class="portlet box green">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>操作栏</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<p>            
									<a href="<?php echo U('Keyword/add');?>" class="btn green">添加关键词</a>         
								</p>
							</div>
						</div>
			...
			<div class="portlet box red">
				<div class="portlet-title">
					<div class="caption"><i class="icon-cogs"></i>关键词列表</div>
					<div class="tools">
						<a href="javascript:;" class="collapse"></a>
						<a href="#portlet-config" data-toggle="modal" class="config"></a>
						<a href="javascript:;" class="reload"></a>
				...
				<div class="portlet-body">
					<table class="table table-hover">
						...
						<tbody>
							<?php if(is_array($keyword)): $i = 0; $__LIST__ = $keyword;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									<td><?php echo ($vo['id']); ?></td>
									<td><?php echo ($vo['values']); ?></td>
									<td><a href="<?php echo U('Keyword/delete','id='.$vo["id"]);?>" class="btn mini green-stripe">删除</a></td>
